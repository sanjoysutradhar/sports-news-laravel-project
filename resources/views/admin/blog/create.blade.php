                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="description" name="description" class="form-control" placeholder="Write some text...." required>{{old('description')}}</textarea>
                                    </div>
                                    @error('description')
                                    <div class="text-red-500 alert alert-danger">{{ $message }}</div>
                                    @enderror
...
{{--                                </div>--}}
                            ...
                            <div class="col-sm-12">
                                ...
                                <a href="{{route('blog.create')}}" class="btn btn-outline-secondary">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
